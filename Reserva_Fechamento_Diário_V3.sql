...
set @dt_movimento     = '20220113'                              -- indique a data de movimento desejada
set @funcional        = 'A07412'                                -- indique a sua funcional
set @analista         = 'Kleyton Arashiro'                               -- indique seu primeiro nome
set @local            = 'SEGUROS'                               -- indique seu local de trabalho
                                                                   -- SEGUROS
                                                                   -- HP
--set @email            = 'evida2@segurosunimed.com.br' -- indique seu e-mail
set @email            = 'kleyton.ferreira@segurosunimed.com.br' -- indique seu e-mail
...
--      where cd_tp_registro in (1,2,3,4,7,8,12,13) -- Corretor, Cliente, Segurado, Beneficiário, Congenere, Sub-Estipulante, Preposto, Agenciador
      ...
      set nm_diretorio = '\\unimed04\e-vida$\Kleyton\' -- OK

      update corp_processo 
      set nm_diretorio = '\\unimed04\e-vida$\Kleyton\' where id_processo = 139 -- OK

      update corp_processo 
      set nm_email = @email 

      update corp_cadastro_processo -- OK
      set nm_caminho = '\\unimed04\e-vida$\Kleyton\'
...
--      set nm_smtp = '10.10.10.5', -- Homologação
      ...
      update corp_forma_pagamento set nm_caminho_emissao = '\\unimed04\e-vida$\Kleyton\Bancaria\Remessa\',
                                      nm_caminho_retorno = '\\unimed04\e-vida$\Kleyton\Bancaria\Retorno\'

update corp_forma_pagamento set nm_caminho_retorno = '\\unimed04\e-vida$\Kleyton\Bancaria\Bancoob\' where cd_forma_pagamento = 756	-- Bancoob
update corp_forma_pagamento set nm_caminho_retorno = '\\unimed04\e-vida$\Kleyton\Bancaria\Bradesco\' where cd_forma_pagamento = 502	-- Bradesco
update corp_forma_pagamento set nm_caminho_retorno = '\\unimed04\e-vida$\Kleyton\Bancaria\Banespa\' where cd_forma_pagamento = 501	-- Banespa
update corp_forma_pagamento set nm_caminho_retorno = '\\unimed04\e-vida$\Kleyton\Bancaria\Itau\' where cd_forma_pagamento = 100	-- Itau
update corp_forma_pagamento set nm_caminho_retorno = '\\unimed04\e-vida$\Kleyton\Bancaria\Itau\' where cd_forma_pagamento = 25	-- Itau
update corp_forma_pagamento set nm_caminho_retorno = '\\unimed04\e-vida$\Kleyton\Bancaria\Uniprime\' where cd_forma_pagamento = 84	-- Uniprime
update corp_forma_pagamento set nm_caminho_retorno = '\\unimed04\e-vida$\Kleyton\Bancaria\BB\' where cd_forma_pagamento = 27	-- BB
